...
class CleanedExcelReport:
    def __init__(self, file: str):
        ...
        self.notes = {}
        self.cleaned_excel_report = self.ten_k_cleaning_excel(pyxl.load_workbook(file))  # pyxl Workbook object

    def ten_k_cleaning_excel(self, excel_report: pyxl.Workbook) -> pyxl.Workbook:
        ...
        for sheets in excel_report.worksheets:
            ...
            self.notes[sheets.title] = sheets['A1'].value  # Units in US Dollars (most likely)
            ...
            copy_style = copy.copy(sheets['A1'].font)
