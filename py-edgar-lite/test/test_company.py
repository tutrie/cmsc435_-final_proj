...
class CompanyTestCase(unittest.TestCase):
    ...
    def test_incorrect_return_10k(self):
        ...
        self.assertEqual(result, None)
        result = company.get_10Q_year('2025', '1')
        self.assertEqual(result, None)
        result = company.get_10Q_year('2001', '1')
        self.assertEqual(result, None)
        result = company.get_10Q_year('hello', '1')
        self.assertEqual(result, None)
        result = company.get_10Q_year(True, '1')
        self.assertEqual(result, None)
        result = company.get_10Q_year(None, '1')
        self.assertEqual(result, None)
        result = company.get_10Q_year(2.4, '1')
        self.assertEqual(result, None)
        result = company.get_10Q_year(2018, '1')
        self.assertEqual(result, None)
